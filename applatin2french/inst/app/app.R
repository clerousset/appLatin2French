...
list_example <-
  data.table(latin = c(
    ...
    french = c(
      ...
      "bien [bjɛ\u0303] (en : good)",
      "boeuf [b\u00f8] (en : ox)",
      "chambre [\u0283\u0251\u0303b\u0280] (en : room)",
      "chanté [\u0283\u0251\u0303te] (en : sung)",
      "chef [\u0283\u025bf] (en : chief)",
      ...
      tabPanel(
        ...
        fluidPage(
          fluidRow(
           ...
           Examples of the book are presented by selecting", strong("Examples."),"A", a("Latin dictionary", href="https://github.com/IohannesArnold/lewis-short-json"), "is also connected to see the natural transformations of any Latin word, select ",strong("Search in dictionary.")," Some rules may be skipped with
             the exception input.
           The pronunciation around the 11th century is of interest because it is the period of the fixation of the spelling.
          The source code is", a("here", href = "https://github.com/clerousset/applatin2french"), "for any remarks or desire to participate make an issue in the github or directly by ", a(href = "mailto:clerousset@protonmail.com", "mail."),
          "The sounds are generated by", strong("espeak"), "with", strong("mbrola"), "additional voices. The voice may stop early when encountering sounds unknown in modern French, for instance [e\u0303]")
          ),
          fluidRow(
          ...
          column(
            ...
            column(
              ...
              dqshiny::autocomplete_input(
                ...
                options = structure(entries, names = entries_for_search),
                max_options = 1000,
                value="capra")
